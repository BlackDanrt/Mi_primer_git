...
public class Pareja {
	...
	public Pareja(String nombre, int edad, LocalDateTime fechaAniversario, String carrera) {
		this.nombre = nombre;
		this.edad = edad;
	...
	public String toString() {
		return "Pareja [id=" + id + ", nombre=" + nombre + ", edad=" + edad + ", fechaAniversario=" + fechaAniversario
				+ ", carrera=" + carrera + "]";
	}
	...
	//Generar un codigo unico alfanumerico que identifica el objeto
	...
	//Compararlos segun el contenido de sus atributos
